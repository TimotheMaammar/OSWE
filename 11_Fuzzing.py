# Script permettant de faire du fuzzing plus complet sur une API

# Utilisation : 
# python3 ./fuzzing.py -a /usr/share/wordlists/dirb/small.txt -w endpoints_simple.txt -t http://apigateway:8000
