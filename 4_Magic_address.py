### PARTIE 4 - ATutor LMS Type Juggling Vulnerability
### 
### Script permettant de faire du bruteforce pour générer une adresse dont les dix premiers caractères du hash MD5 auront un format de type 0eXXXXXXXX.
### Dès qu'on obtient un magic hash permettant de valider la loose comparison, le script fait ensuite une modification de l'adresse mail de la cible.
###
### Utilisation :  
