# Script permettant d'automatiser la requête de reset de mot de passe
# Ce script utilise le fichier tokens.txt à générer au préalable
# 
# Utilisation : python 8_Password_reset.py -u guest -p password
#
#!/usr/bin/python3
